...
var assignedBody: Node2D = null


func _init(genome_id: int, initial_neurons: Dictionary, initial_links: Dictionary, bd: Node2D) -> void:
...
func generate_agent() -> Agent:
	...
	agent = Agent.new(new_network, is_leader_clone, assignedBody)
	return agent
